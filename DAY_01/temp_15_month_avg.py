...
def main():
    ...
    print(f'{first_decade}년대 {search_month}월의 최고 기온 평균: {first_decade_max_temp_list}')
    print(f'{second_decade}년대 {search_month}월의 최고 기온 평균: {second_decade_max_temp_list}')

    first_decade_max_temp_mean = round(sum(first_decade_max_temp_list)/ len(first_decade_max_temp_list), 1)
    second_decade_max_temp_mean = round(sum(second_decade_max_temp_list)/ len(second_decade_max_temp_list), 1)
